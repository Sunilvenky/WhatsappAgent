...
echo ""
echo "To check logs: ssh -i 'C:\Users\kkavi\OneDrive\Desktop\oraclekeys\ssh-key-2025-10-14.key' ubuntu@129.159.227.138"
echo "Then run: cd /home/ubuntu/whatsapp-agent"
echo "Then run: docker-compose -f infra/docker-compose.yml logs"
echo "=========================================="
"@
...
if ($exitCode -eq 0) {
    ...
    Write-Output "Access the API at: http://129.159.227.138"
    Write-Output "API Documentation: http://129.159.227.138/docs"
    Write-Output "Adminer: http://129.159.227.138:8080"
    Write-Output ""
    ...
    Write-Output ""
    Write-Output "To check logs: ssh -i '$SSH_KEY_PATH' ubuntu@$VM_IP"
    ...
    Write-Output "SSH Command Result: $sshResult"
    exit 1
}